...
class Embed:
    def inCall(ctx, invite, icon):
        ...
        inCall.set_footer(text="Made by Lapt💙💛ka", icon_url="https://cdn.discordapp.com/avatars/424172023418454020/6fca84235b59a619b7d3bb2d471d2fa4.png?size=256")
        inCall.set_image(url="https://i.pinimg.com/originals/df/7a/aa/df7aaaa291637eb293a401426ed6fdb2.jpg")
